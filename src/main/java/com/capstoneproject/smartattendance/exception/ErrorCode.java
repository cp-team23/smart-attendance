...
public enum ErrorCode {
    ...
    ENROLLMENT_NOT_AVAILABLE(HttpStatus.BAD_REQUEST),

    STUDENT_PRESENT_IN_RECYCLE_BIN(HttpStatus.BAD_REQUEST),
    TEACHER_PRESENT_IN_RECYCLE_BIN(HttpStatus.BAD_REQUEST),
    ...
    CANT_DELETE_ACADEMIC_ATTENDANCE(HttpStatus.BAD_REQUEST),
    // ATTENDANCE
    ATTENDANCE_RECORD_NOT_FOUND(HttpStatus.NOT_FOUND),
    ACADEMIC_NOT_PRESENT(HttpStatus.NOT_FOUND),
    ...
    ATTENDANCE_ALREADY_MARKED(HttpStatus.BAD_REQUEST),
    ATTENDANCE_IS_CLOSED(HttpStatus.BAD_REQUEST),
