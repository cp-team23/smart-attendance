...
public class AdminController {
    ...
    public ResponseEntity<?> createAcademicStructure(@Valid @RequestBody AcademicDto academicDto,
    ...
    public ResponseEntity<?> updateAcademicStructure(@Valid @RequestBody AcademicDto academicDto,
            Authentication authentication) {
        String adminId = authentication.getName();
    ...
    public ResponseEntity<?> addStudent(@Valid @RequestBody StudentDto studentDto, Authentication authentication) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Map.of("message", "STUDENT_ACCOUNT_CREATED_SUCCESSFULLY"));
    }
    ...
    public ResponseEntity<?> approveImageChangeRequest(Authentication authentication, @PathVariable String userId)
            throws IOException {
        String adminId = authentication.getName();
    ...
    public ResponseEntity<?> rejectImageChangeRequest(Authentication authentication, @PathVariable String userId)
            throws IOException {
        String adminId = authentication.getName();
    ...
    public ResponseEntity<?> addTeacher(@Valid @RequestBody TeacherDto teacherDto, Authentication authentication) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Map.of("message", "TEACHER_ACCOUNT_CREATED_SUCCESSFULLY"));
    }
    ...
    public ResponseEntity<?> updateAttendance(Authentication authentication, @PathVariable UUID attendanceId,
            @Valid @RequestBody SaveAttendanceDto saveAttendanceDto) {
        String adminId = authentication.getName();
    ...
    public ResponseEntity<?> removeStudentImage(Authentication authentication, @PathVariable String userId)
            throws IOException {
        String adminId = authentication.getName();
    ...
    public ResponseEntity<?> addMultipleStudentImage(
            Authentication authentication,
            @RequestParam("images") List<MultipartFile> images) throws IOException {

        String adminId = authentication.getName();
        List<ImageApprovalResult> responses = adminService.addMultipleStudentImageService(adminId, images);
