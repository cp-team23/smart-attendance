    ...
    cardsContainer.innerHTML = `
        <div class="bulk-layout">
            ...
            <div class="bulk-upload-panel">
                ...
                <button id="uploadExcelBtn" class="gradient-btn">
                    Start Upload
                </button>

                <div class="download-area" id="downloadArea" style="display:none;">
                    <button id="downloadReportBtn" class="secondary-btn">
...
async function addStudentAPI(userData, isBulk = false) {
    ...
    // Validation only for single add
    if (!isBulk) {
...
function generateOutputExcel(data) {
    ...
    const fileName = "Bulk_Upload_Report.xlsx";
